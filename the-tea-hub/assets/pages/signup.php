<div class="login">
  <div class="col-lg-4 col-md-8 col-sm-12 bg-white border rounded p-4 shadow-sm">
    <form method="post" action="assets/php/actions.php?signup">
      ...
      <h1 class="h5 mb-3 fw-normal">Create a TTH Account</h1>
      ...
      <div class="d-flex">
        ...
        <div class="form-floating mt-1 col-6">
          <input type="text" name="last_name" value="<?=showFormData('last_name')?>" class="form-control rounded-0" placeholder="Surname">
      ...
      <div class="d-flex gap-3 my-3">
        ...
        <div class="form-check">
          ...
          <label class="form-check-label" for="exampleRadios2">Prefer Not To Say</label>
        </div>
      </div>
      ...
      <div class="mt-3 d-flex justify-content-between align-items-center">
        ...
        <a href="?login" class="text-decoration-none">Already have a TTH account?</a>
      </div>
    </form>
  </div>
</div>