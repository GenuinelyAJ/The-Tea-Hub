...
<nav class="navbar navbar-expand-lg navbar-light bg-white border">
    <div class="container col-lg-9 col-sm-12 col-md-10 d-flex flex-lg-row flex-md-row flex-sm-column justify-content-between">
        <div class="d-flex justify-content-between col-lg-9 col-sm-12">
            <a class="navbar-brand" href="?">
                <img src="assets/images/TTH.png" alt="" height="28">
            </a>

            <!-- Search bar -->
            <form class="d-flex col-lg-5" id="searchform">
                <input class="form-control me-2" type="search" id="search" placeholder="Search for users..." aria-label="Search" autocomplete="off">
                <div class="bg-white text-end rounded border shadow py-3 px-4 mt-5" style="display:none;position:absolute;z-index:+99;" id="search_result" data-bs-auto-close="true">
                    ...
                    <div id="sra" class="text-start">
                        <p class="text-center text-muted">Find a Tea Hub User.</p>
                    </div>
                </div>
            </form>
        </div>
        ...
        <!-- Navigation buttons -->
        <ul class="navbar-nav flex-fill flex-row justify-content-evenly mb-lg-2 mb-sm-0">
            <li class="nav-item">
