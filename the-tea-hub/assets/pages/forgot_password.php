<div class="login">
  <div class="col-lg-4 col-md-8 col-sm-12 bg-white border rounded p-4 shadow-sm">
    ...
    <form method="post" action="assets/php/actions.php?<?=$action?>">
      ...
      <br>
      <button class="btn btn-primary" type="submit">Send Verification OTP</button>
      ...
      ?>
      <p>Enter the 6-Digit OTP sent to - <?=$_SESSION['forgot_email']?></p>
      ...
      <br>
      <button class="btn btn-primary" type="submit">OTP</button>
      ...
      ?>
      <p>Enter a new password - <?=$_SESSION['forgot_email']?></p>
      <div class="form-floating mt-1">
