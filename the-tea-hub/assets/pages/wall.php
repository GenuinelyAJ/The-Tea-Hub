...
?>
    <div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
        <div class="col-md-8 col-sm-12" style="max-width:93vw">
            <!-- Shows an error if there is no posts in the feed -->
            <?php
            showError('post_img');
            if(count($posts)<1){
...
<div class="d-flex justify-content-between">
    ...
    <?php
        ...
        <div class="col-lg-4 col-sm-0 overflow-hidden mt-4 p-sm-0 p-md-3">
            ...
            <div>
                <h6 class="text-muted p-2">Check out other Tea Spillers!</h6>
                <?php
...
if(count($follow_suggestions)<1){
    echo "<p class='p-2 bg-white border rounded text-center'>No TTH Members For You</p>";
}
                ?>
            </div>
        </div>
